...
int main(int argc, char* argv[])
{
	...
	// Load texture
	const char * texFilename = "../resources/textures/FireGround.png";
	...
	gCamera.Position = glm::vec3(0.0f, 3.0f, 1.0f);
...
void URender()
{
	...
	// 2. Rotates shape by 15 degrees in the x axis
	rotation = glm::rotate(-0.2f, glm::vec3(2.0, 0.0f, 0.0f));
	// 3. Place object at the origin
	translation = glm::translate(glm::vec3(-0.4f, 2.0f, -1.5f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
	...
	scale = glm::scale(glm::vec3(1.0f, 1.0f, 0.125f));
	// 2. Rotates shape by 15 degrees in the x axis
	rotation = glm::rotate(3.15f, glm::vec3(0.0, 0.0f, 1.0f));
	// 3. Place object at the origin
	translation = glm::translate(glm::vec3(-0.4f, 1.0f, -2.0f));
	// Model matrix: transformations are applied right-to-left order
	model = translation * rotation * scale;
